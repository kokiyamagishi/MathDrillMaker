        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "20px", alignItems: "center" }}>
            <div className="math-illustration" style={{ display: "flex", gap: "16px", padding: "20px 28px", border: "3px dashed #4CAF50", borderRadius: "16px", width: "fit-content", alignItems: "center", backgroundColor: "#F1F8E9" }}>
              ...
              <span style={{ fontSize: "22px", fontWeight: "bold", color: "#555" }}>{"ແມ່ນ"}</span>
              ...
              <span style={{ fontSize: "22px", fontWeight: "bold", color: "#888" }}>{"ແລະ"}</span>
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "16px" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(1)"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(2)"}</span>
                <span style={{ fontSize: "24px", minWidth: "30px" }}>{"5"}</span>
                <span>{"="}</span>
                <span className="answer-blank" style={{ display: "inline-block", width: "50px", height: "40px" }}></span>
                <span>{"ແລະ"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(3)"}</span>
                <span style={{ fontSize: "24px", minWidth: "30px" }}>{"6"}</span>
                <span>{"="}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(4)"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(5)"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(6)"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(7)"}</span>
                <span style={{ fontSize: "24px", minWidth: "30px" }}>{"10"}</span>
                <span>{"="}</span>
                <span style={{ fontSize: "24px" }}>{"6"}</span>
                <span>{"ແລະ"}</span>
                <span className="answer-blank" style={{ display: "inline-block", width: "50px", height: "40px" }}></span>
              </div>
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(8)"}</span>
                <span style={{ fontSize: "24px", minWidth: "30px" }}>{"10"}</span>
                <span>{"="}</span>
                <span className="answer-blank" style={{ display: "inline-block", width: "50px", height: "40px" }}></span>
                <span>{"ແລະ"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(9)"}</span>
                <span style={{ fontSize: "24px", minWidth: "30px" }}>{"8"}</span>
                <span>{"="}</span>
                <span style={{ fontSize: "24px" }}>{"4"}</span>
                <span>{"ແລະ"}</span>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                <span style={{ fontSize: "18px", fontWeight: "bold", minWidth: "30px" }}>{"(10)"}</span>
                <span style={{ fontSize: "24px", minWidth: "30px" }}>{"7"}</span>
                <span>{"="}</span>
                <span className="answer-blank" style={{ display: "inline-block", width: "50px", height: "40px" }}></span>
                <span>{"ແລະ"}</span>
