          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "16px", padding: "10px", backgroundColor: "#E8F5E9", borderRadius: "8px", border: "1px solid #C8E6C9", fontSize: "1.15rem", color: "#2E7D32" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", width: "100%" }}>
                <span>{"ເສັ້ນສະແດງຂອງຕຳລາ: 𝑦 = 2𝑥 + 1"}</span>
                <svg viewBox="0 0 400 240" style={{ width: "100%", maxWidth: "400px", height: "auto" }}>
                  ...
                  <text x="370" y="184" fill="#37474F" fontSize="16" fontWeight="bold">𝑥</text>
                  <text x="210" y="30" fill="#37474F" fontSize="16" fontWeight="bold">𝑦</text>
      ...
      problems: [
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#2C3E50", margin: 0 }}>
                {"ຄຳຖາມທີ 1: ຈົ່ງກຳນົດສຳປະສິດສະໂລບ a ແລະ ຈຸດຕັດແກນ 𝑦 (b) ຂອງຕຳລາຕໍ່ໄປນີ້: "}<span className="point-label">{"(ຂໍ້ລະ 2 ຄະແນນ, ລວມ 6 ຄະແນນ)"}</span>
              </p>
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#2C3E50", margin: 0 }}>
                {"ຄຳຖາມທີ 2: ຈົ່ງຊອກຫາສົມຜົນຕຳລາຂັ້ນໜຶ່ງ 𝑦 = ax + b ຈາກເງື່ອນໄຂລຸ່ມນີ້: "}<span className="point-label">{"(ຂໍ້ລະ 2 ຄະແນນ, ລວມ 4 ຄະແນນ)"}</span>
              </p>
    ...
    },
    {
      ...
      keyPoint: {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ການຊອກຫາຈຸດຕັດແກນນອນ (ແກນ 𝑥) ແລະ ຄ່າຂອງຕຳລາຂັ້ນໜຶ່ງ:"}
            </p>
      ...
      problems: [
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#2C3E50", margin: 0 }}>
                {"ຄຳຖາມທີ 1: ຈົ່ງຄິດໄລ່ຫາຄ່າຂອງ 𝑦 ຫຼື f(𝑥) ຈາກຄ່າ 𝑥 ທີ່ກຳນົດໃຫ້: "}<span className="point-label">{"(ຂໍ້ລະ 2 ຄະແນນ, ລວມ 6 ຄະແນນ)"}</span>
              </p>
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#2C3E50", margin: 0 }}>
                {"ຄຳຖາມທີ 2: ຈົ່ງຊອກຫາຕົວປະສານງານແກນ 𝑥 (ຄ່າຂອງ 𝑥) ທີ່ເປັນຈຸດຕັດແກນ 𝑥: "}<span className="point-label">{"(ຂໍ້ລະ 2 ຄະແນນ, ລວມ 4 ຄະແນນ)"}</span>
              </p>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"(2) ຈົ່ງຊອກຫາຄ່າປະສານງານ 𝑥 ຂອງເມັດຕັດກັນລະຫວ່າງສອງເສັ້ນຊື່ "} <span className="math">{"𝑦 = 3𝑥 - 1"}</span> {" ແລະ "} <span className="math">{"𝑦 = 𝑥 + 5"}</span> {". (ຄຳແນະນຳ: ໃຫ້ຕັ້ງສົມຜົນ 3𝑥 - 1 = 𝑥 + 5 ແລ້ວແກ້ຫາ 𝑥)"}
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
              <span>{"ຕອບ: 𝑥 ="}</span>
              <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
  ...
  summaryProblems: [
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"ໃນອ່າງນ້ຳມີນ້ຳຢູ່ແລ້ວ 20 ລີດ, ເມື່ອໄຂກ໊ອກຕື່ມນ້ຳໃສ່ຕື່ມໃນອັດຕາ 3 ລີດຕໍ່ນາທີ. ຂຽນເປັນຕຳລາແມ່ນ "} <span className="math">{"𝑦 = 3𝑥 + 20"}</span> {" (ລີດ) ໂດຍ 𝑥 ແມ່ນເວລາເປັນນາທີ. ຖ້າໄຂກ໊ອກນ້ຳເປັນເວລາ 10 ນາທີ, ຈະມີນ້ຳທັງໝົດໃນອ່າງຈັກລີດ?"}
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"(2) ໃຫ້ຕຳລາຂັ້ນໜຶ່ງ "} <span className="math">{"f(𝑥) = ax + b"}</span> {" ໂດຍຮູ້ວ່າ "} <span className="math">{"f(0) = 4"}</span> {" ແລະ "} <span className="math">{"f(2) = 10"}</span> {". ຈົ່ງຊອກຫາຄ່າຂອງ "} <span className="math">{"f(5)"}</span> {"."}
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
            <span>{"ຕອບ: f(5) ="}</span>
            <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
    ...
    items: [
      {
        questionNumber: 1,
        answers: [
          <span key="1">{"(1) a = 3, b = 5 (ເພາະວ່າທຽບໃສ່ຮູບແບບ 𝑦 = ax + b ຈະໄດ້ a = 3, b = 5)"}</span>,
          <span key="2">{"(2) a = -2, b = 7 (ເພາະວ່າທຽບໃສ່ຮູບແບບ 𝑦 = ax + b ຈະໄດ້ a = -2, b = 7)"}</span>,
          <span key="3">{"(3) a = 4, b = -9 (ເພາະວ່າທຽບໃສ່ຮູບແບບ 𝑦 = ax + b ຈະໄດ້ a = 4, b = -9)"}</span>
        ]
      },
      {
        questionNumber: 2,
        answers: [
          <span key="4">{"(1) 𝑦 = 4𝑥 - 3 (ແທນ a = 4, b = -3 ໃສ່ສົມຜົນທົ່ວໄປ 𝑦 = ax + b)"}</span>,
          <span key="5">{"(2) 𝑦 = -5𝑥 + 2 (ເສັ້ນຊື່ຂະໜານກັນມີ a ເທົ່າກັນ ➔ a = -5, ແລະ ຕັດແກນ 𝑦 ຢູ່ (0, 2) ➔ b = 2)"}</span>
        ]
      },
      {
        questionNumber: "ທ້າທາຍ 1",
        answers: [
          <span key="6">{"3 (ຊອກຫາຄວາມຊັນຈາກສູດ a = (𝑦₂ - 𝑦₁) / (𝑥₂ - 𝑥₁) = (11 - 5) / (3 - 1) = 6 / 2 = 3)"}</span>
        ]
      },
      {
        questionNumber: "ທ້າທາຍ 2",
        answers: [
          <span key="7">{"3 (ຕັ້ງສົມຜົນ 3𝑥 - 1 = 𝑥 + 5 ➔ 2𝑥 = 6 ➔ 𝑥 = 3)"}</span>
        ]
      },
      {
        questionNumber: "ທົດສອບປະຈຳບົດ 1",
        answers: [
          <span key="8">{"50 (ແທນ 𝑥 = 10 ນາທີ ໃສ່ຕຳລາ 𝑦 = 3(10) + 20 = 30 + 20 = 50 ລີດ)"}</span>
        ]
      },
      {
        questionNumber: "ທົດສອບປະຈຳບົດ 2",
        answers: [
          <span key="9">{"19 (ຈາກ f(0) = b ➔ b = 4. ຈາກ f(2) = 2a + 4 = 10 ➔ 2a = 6 ➔ a = 3. ດັ່ງນັ້ນ f(𝑥) = 3𝑥 + 4 ➔ f(5) = 3(5) + 4 = 19)"}</span>
        ]
      }
    ],
