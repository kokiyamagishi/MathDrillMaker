...
export const unit22Data: UnitData = {
  ...
  unitGoal: "ຮຽນຮູ້ ແລະ ນຳໃຊ້ວິທີຄິດໄລ່ຄ່າສະເລ່ຍ ແລະ ຂອບເຂດ ຂອງຂໍ້ມູນດ່ຽວ ແລະ ຂໍ້ມູນແບ່ງຊັ້ນ",
  textbookRef: "ປຶ້ມແບບຮຽນ ມ.3 ໜ້າ 109-114",
  subSections: [
    {
      title: "1. ຄ່າສະເລ່ຍ ແລະ ຂອບເຂດຂອງຂໍ້ມູນດ່ຽວ",
      keyPoint: {
        title: "ນິຍາມ ແລະ ສູດຄິດໄລ່ຂໍ້ມູນດ່ຽວ",
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ຄ່າສະເລ່ຍ ສະແດງເຖິງຄ່າຈຸດໃຈກາງຂອງຂໍ້ມູນ, ສ່ວນຂອບເຂດ ສະແດງເຖິງການກະຈາຍຂອງຂໍ້ມູນ:"}
            </p>
            <div style={{ padding: "12px 16px", backgroundColor: "#E3F2FD", borderRadius: "10px", border: "1px solid #90CAF9", fontSize: "1.25rem", color: "#1565C0", display: "flex", flexDirection: "column", gap: "6px" }}>
              <div style={{ display: "inline-flex", alignItems: "center" }}>
                {"• ຄ່າສະເລ່ຍ (𝑥̄): "}
                <span className="math" style={{ marginLeft: "4px" }}>
                  {"𝑥̄ = "} <Fraction num="ຜົນບວກຂອງຂໍ້ມູນທັງໝົດ" den="ຈຳນວນຂໍ້ມູນ N" />
                </span>
              </div>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "16px", padding: "10px", backgroundColor: "#E8F5E9", borderRadius: "8px", border: "1px solid #C8E6C9", fontSize: "1.15rem", color: "#2E7D32" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", width: "100%" }}>
                ...
                <svg viewBox="0 0 400 160" style={{ width: "100%", maxWidth: "360px", height: "auto" }}>
                  {/* Balance Scale lever */}
                  <line x1="40" y1="100" x2="360" y2="100" stroke="#37474F" strokeWidth="6" />
                  
                  {/* Pivot */}
                  <polygon points="100,50 90,75 110,75" fill="#2E7D32" />
                  <text x="200" y="174" fill="#2E7D32" fontSize="16" textAnchor="middle" fontWeight="bold">{"ຄ່າສະເລ່ຍ (𝑥̄ = 6)"}</text>

                  {/* Weights */}
                  {/* Left weight */}
                  <rect x="70" y="76" width="24" height="24" fill="#E65100" />
                  <text x="82" y="94" fill="#FFFFFF" fontSize="14" textAnchor="middle">{"2"}</text>

                  <rect x="130" y="76" width="24" height="24" fill="#E65100" />
                  <text x="142" y="94" fill="#FFFFFF" fontSize="14" textAnchor="middle">{"4"}</text>

                  {/* Right weight */}
                  <rect x="250" y="76" width="24" height="24" fill="#E65100" />
                  <text x="262" y="94" fill="#FFFFFF" fontSize="14" textAnchor="middle">{"8"}</text>

                  <rect x="306" y="76" width="24" height="24" fill="#E65100" />
                  <text x="318" y="94" fill="#FFFFFF" fontSize="14" textAnchor="middle">{"10"}</text>
                </svg>
              </div>
            </div>
          </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  ...
                  <span>{"ຄ່າສະເລ່ຍ (𝑥̄) ຂອງກຸ່ມຂໍ້ມູນນີ້ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>

                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" }}>{"(3)"}</span>
                  <span>{"ຂອບເຂດ ຂອງກຸ່ມຂໍ້ມູນນີ້ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
              </div>
            </div>
    ...
    {
      title: "2. ຄ່າສະເລ່ຍຂອງຂໍ້ມູນແບ່ງຊັ້ນ",
      keyPoint: {
        title: "ເມັດເຄິ່ງກາງຊັ້ນ ແລະ ການຄິດໄລ່",
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ສຳລັບຂໍ້ມູນແບ່ງຊັ້ນ, ເຮົາຕ້ອງຊອກຫາເມັດເຄິ່ງກາງຊັ້ນ (𝑥ᵢ) ຂອງແຕ່ລະຊັ້ນກ່ອນ:"}
            </p>
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" }}>{"(2)"}</span>
                  <span>{"ຊັ້ນ "} <span className="math">{"20 - 30"}</span> {" ມີຄວາມຖີ່ 4, ຜົນຄູນລະຫວ່າງຄວາມຖີ່ ແລະ ເມັດເຄິ່ງກາງ (fᵢ × 𝑥ᵢ) ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>

                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" }}>{"(3)"}</span>
                  <span>{"ມີສອງຊັ້ນ: "} <span className="math">{"10-20"}</span> {" (ຄວາມຖີ່ 2) ແລະ "} <span className="math">{"20-30"}</span> {" (ຄວາມຖີ່ 2). ຄ່າສະເລ່ຍ 𝑥̄ ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
              </div>
            </div>
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" }}>{"(2)"}</span>
                  <span>{"ຖ້າຜົນຄູນລວມ Σ(fᵢ × 𝑥ᵢ) ແມ່ນ 300 ແລະ N = 15. ຄ່າສະເລ່ຍ 𝑥̄ ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
              </div>
            </div>
    ...
    problems: [
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#E65100", margin: 0 }}>
              {"ການຫາຄ່າຂໍ້ມູນທີ່ຕ້ອງເພີ່ມເພື່ອໄດ້ຄ່າສະເລ່ຍຕາມເປົ້າໝາຍ: "}<span className="point-label">{"(5 ຄະແນນ)"}</span>
            </p>
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#E65100", margin: 0 }}>
              {"ການຊອກຫາຄ່າສະເລ່ຍໃໝ່ຫຼັງຈາກເພີ່ມຂໍ້ມູນ: "}<span className="point-label">{"(5 ຄະແນນ)"}</span>
            </p>
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#006064", margin: 0 }}>
            {"ໂຈດຂອບເຂດອຸນຫະພູມປະຈຳອາທິດ: "}<span className="point-label">{"(5 ຄະແນນ)"}</span>
          </p>
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"ອຸນຫະພູມທີ່ວັດແທກໄດ້ໃນ 7 ວັນຂອງອາທິດໜຶ່ງແມ່ນ 25, 27, 26, 29, 31, 28, 26 ອົງສາເຊ. ຈົ່ງຊອກຫາຂອບເຂດ ຂອງອຸນຫະພູມໃນອາທິດນີ້."}
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"(2) ໃຫ້ອຸນຫະພູມທີ່ວັດແທກໄດ້ໃນ 7 ວັນແມ່ນ: 24, 26, 25, 28, 30, 27, 22 ອົງສາເຊ. ຈົ່ງຄິດໄລ່ຫາຄ່າສະເລ່ຍ (𝑥̄) ຂອງອຸນຫະພູມໃນອາທິດນີ້."}
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
    ...
    items: [
      {
        ...
        answers: [
          ...
          <span key="2">{"(2) 6 (ເພາະວ່າ ຄ່າສະເລ່ຍ 𝑥̄ = 30 / 5 = 6)"}</span>,
      ...
      },
      {
        questionNumber: 2,
        answers: [
          <span key="4">{"(1) 6 (ເພາະວ່າ ຜົນບວກ = 30, N = 5 ➔ 𝑥̄ = 30 / 5 = 6)"}</span>,
      ...
      },
      {
        ...
        answers: [
          <span key="9">{"26 (ເພາະວ່າ ຜົນບວກອຸນຫະພູມທັງ 7 ວັນແມ່ນ 182 ➔ ຄ່າສະເລ່ຍ 𝑥̄ = 182 / 7 = 26 ອົງສາເຊ)"}</span>
        ]
      }
    ],
  ...
  items: [
    {
      ...
      answers: [
        ...
        <span key="11">{"100 (ເພາະວ່າ ເມັດເຄິ່ງກາງຊັ້ນແມ່ນ 25 ➔ fᵢ × 𝑥ᵢ = 4 × 25 = 100)"}</span>,
        <span key="12">{"20 (ເພາະວ່າ ຜົນຄູນລວມ = 2×15 + 2×25 = 30+50 = 80, N = 4 ➔ 𝑥̄ = 80 / 4 = 20)"}</span>
      ]
    },
    {
      questionNumber: 2,
      answers: [
        ...
        <span key="14">{"20 (ເພາະວ່າ 𝑥̄ = Σ(fᵢ × 𝑥ᵢ) / N = 300 / 15 = 20)"}</span>
      ]
    }
  ]
};
