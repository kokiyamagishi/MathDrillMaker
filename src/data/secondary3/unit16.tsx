      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"(2) ໃນຮູບສີ່ແຈຂະໜານ ABCD, ມີສອງມຸມຖັດກັນແມ່ນ "} <span className="math">{"<Angle>A</Angle> = 2𝑥 + 10"}</span> {" ແລະ "} <span className="math">{"<Angle>B</Angle> = 3𝑥 - 20"}</span> {" (ອົງສາ). ຈົ່ງຊອກຫາຄ່າຂອງ 𝑥."}
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
              <span>{"ຕອບ: 𝑥 ="}</span>
              <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
    ...
    },
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"(2) ສີ່ຄ່າມຸມໃນຂອງຮູບສີ່ແຈໜຶ່ງແມ່ນ 𝑥, 2𝑥, 3𝑥, 4𝑥. ຈົ່ງຊອກຫາຂະໜາດຂອງມຸມທີ່ໃຫຍ່ທີ່ສຸດ."}
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
            <span>{"ຕອບ: ມຸມທີ່ໃຫຍ່ທີ່ສຸດແມ່ນ"}</span>
            <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
    ...
    items: [
      ...
      },
      {
        ...
        answers: [
          ...
          <span key="5">{"(2) 75° (ເພາະວ່າມຸມນອກ 120° = 45° + 𝑥 ➔ 𝑥 = 120° - 45° = 75°)"}</span>
        ]
      },
      {
      ...
      },
      {
        ...
        answers: [
          <span key="7">{"38 (ສອງມຸມຖັດກັນບວກກັນໄດ້ 180° ➔ (2𝑥 + 10) + (3𝑥 - 20) = 180 ➔ 5𝑥 - 10 = 180 ➔ 5𝑥 = 190 ➔ 𝑥 = 38)"}</span>
        ]
      },
      {
      ...
      },
      {
        ...
        answers: [
          <span key="9">{"144° (ຜົນບວກມຸມໃນຮູບສີ່ແຈແມ່ນ 360° ➔ 𝑥 + 2𝑥 + 3𝑥 + 4𝑥 = 360 ➔ 10𝑥 = 360 ➔ 𝑥 = 36° ➔ ມຸມໃຫຍ່ສຸດ 4𝑥 = 4×36 = 144°)"}</span>
        ]
      }
    ],
