            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  ...
                  <span>{"ສົມຜົນ "} <span className="math">{"𝑥² - 5𝑥 + 6 = 0"}</span> {" ມີຄ່າ Δ ເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
                
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" , whiteSpace: "nowrap"}}>{"(2) "}</span>
                  <span>{"ສົມຜົນ "} <span className="math">{"𝑥² - 4𝑥 + 4 = 0"}</span> {" ມີຄ່າ Δ ເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>

                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" , whiteSpace: "nowrap"}}>{"(3) "}</span>
                  <span>{"ສົມຜົນ "} <span className="math">{"𝑥² - 2𝑥 + 5 = 0"}</span> {" ມີຄ່າ Δ ເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
              </div>
            </div>
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" , whiteSpace: "nowrap"}}>{"(1) "}</span>
                  <span>{"ສົມຜົນ "} <span className="math">{"𝑥² - 6𝑥 + 9 = 0"}</span> {" ມີຈຳນວນໃຈຜົນຈັກໃຈຜົນ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>

                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" , whiteSpace: "nowrap"}}>{"(2) "}</span>
                  <span>{"ສົມຜົນ "} <span className="math">{"𝑥² - 3𝑥 + 5 = 0"}</span> {" ມີຈຳນວນໃຈຜົນຈັກໃຈຜົນ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
              </div>
            </div>
            ...
            <div style={{ padding: "12px 16px", backgroundColor: "#FFFDE7", borderRadius: "10px", border: "1px solid #FFF59D", fontSize: "1.25rem", color: "#F57F17", display: "flex", flexDirection: "column", gap: "10px" }}>
              <div style={{ display: "inline-flex", alignItems: "center" }}>
                ...
                <span className="math" style={{ marginLeft: "4px" }}>
                  {"𝑥 = "} <Fraction num="-b ± √Δ" den="2a" />
                </span>
              </div>
              <div style={{ fontWeight: "bold", color: "#D84315" }}>{"• ຕົວຢ່າງ: 𝑥² - 4𝑥 - 5 = 0 ➔ Δ = (-4)² - 4(1)(-5) = 16 + 20 = 36 ➔ √Δ = 6."}</div>
              <div style={{ fontWeight: "bold", color: "#D84315", paddingLeft: "16px" }}>
                {"➔ 𝑥 = "} <span className="math"><Fraction num="-(-4) ± 6" den="2(1)" /> {" = "} <Fraction num="4 ± 6" den="2" /></span> {" ➔ ໃຈຜົນແມ່ນ 5 ຫຼື -1."}
              </div>
            </div>
          </div>
        ),
      ...
      problems: [
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p style={{ fontSize: "1.375rem", fontWeight: "bold", color: "#2C3E50", margin: 0 }}>
                {"ຄຳຖາມທີ 1: ຈົ່ງຊອກຫາໃຈຜົນຂອງສົມຜົນຂັ້ນສອງ 𝑥² - 4𝑥 - 5 = 0: "}<span className="point-label">{"(ຂໍ້ລະ 2 ຄະແນນ, ລວມ 6 ຄະແນນ)"}</span>
              </p>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                ...
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" , whiteSpace: "nowrap"}}>{"(3) "}</span>
                  <span>{"ໃຈຜົນຊ້ອນຂອງສົມຜົນ "} <span className="math">{"𝑥² - 6𝑥 + 9 = 0"}</span> {" ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
              </div>
            </div>
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "20px", padding: "8px 0" }}>
                <div style={{ display: "flex", alignItems: "flex-start", gap: "12px", flexWrap: "nowrap", fontSize: "1.375rem" }}>
                  <span style={{ fontWeight: "bold" , whiteSpace: "nowrap"}}>{"(1) "}</span>
                  <span>{"ໃຈຜົນທີ່ເປັນຄ່າບວກຂອງສົມຜົນ "} <span className="math">{"2𝑥² - 3𝑥 - 2 = 0"}</span> {" ແມ່ນເທົ່າໃດ?"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
                </div>
    ...
    problems: [
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ຈົ່ງຊອກຫາຜົນບວກຂອງສອງໃຈຜົນ "} <span className="math">{"(𝑥_1 + 𝑥_2)"}</span> {" ຂອງສົມຜົນຂັ້ນສອງ "} <span className="math">{"3𝑥² - 12𝑥 + 5 = 0"}</span> {". (ຄຳແນະນຳ: ນຳໃຊ້ສູດວີແອດ 𝑥_1 + 𝑥_2 = -b/a)"}
            </p>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"(2) ຈົ່ງຊອກຫາຄ່າຂອງຕົວປ່ຽນ m ທີ່ເຮັດໃຫ້ສົມຜົນຂັ້ນສອງ "} <span className="math">{"𝑥² - 6𝑥 + m = 0"}</span> {" ມີພຽງແຕ່ 1 ໃຈຜົນຊ້ອນ."}
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
              <span>{"ຕອບ: m ="}</span>
              <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
  ...
  summaryProblems: [
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"ຈົ່ງແກ້ສົມຜົນ "} <span className="math">{"𝑥² - 2𝑥 - 1 = 0"}</span> {" ໂດຍນຳໃຊ້ສູດທົ່ວໄປ ຈະໄດ້ໃຈຜົນບວກຢູ່ໃນຮູບແບບ "} <span className="math">{"a + √b"}</span> {". ຈົ່ງຊອກຫາຄ່າຂອງ a + b."}
          </p>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
            <span>{"ຕອບ: a + b ="}</span>
            <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "42px" }}></span>
  ...
  answers: {
    items: [
      ...
      },
      {
        ...
        answers: [
          <span key="8">{"3 (ແກ້ສົມຜົນ ➔ 𝑥 = (2 ± √8) / 2 = 1 ± √2 ➔ ໃຈຜົນບວກແມ່ນ 1 + √2 ➔ a = 1, b = 2 ➔ a + b = 3)"}</span>
        ]
      },
      {
        questionNumber: "ທົດສອບປະຈຳບົດ 2",
        answers: [
          <span key="9">{"6 m (ລວງຮອບ = 2(𝑥+𝑦) = 20 ➔ 𝑥+𝑦 = 10. ເນື້ອທີ່ = 𝑥𝑦 = 24 ➔ ສ້າງສົມຜົນ: 𝑥(10-𝑥) = 24 ➔ 𝑥²-10𝑥+24 = 0 ➔ (𝑥-4)(𝑥-6)=0 ➔ ຂ້າງຍາວແມ່ນ 6 m)"}</span>
        ]
      }
    ],
