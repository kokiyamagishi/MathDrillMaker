...
export const unit7Data: UnitData = {
  ...
  challengeProblems: {
    ...
    hintIndex: 0,
    hintText: "ສູດ: A/P = (1+r)² ⇒ 4,867,200 / 4,000,000 = 1.2168 ⇒ (1+r) = √1.2168 = 1.10? ຂໍໂທດ, √1.2168 ແມ່ນ 1.103. ຖ້າ Δ/P = 1.08? ລອງຄິດໄລ່: (1.1)² = 1.21, ດັ່ງນັ້ນ 1+r = 1.10 ⇒ r = 10%. ສ່ວນໂຈດກູ້ຢືມລົດຈັກ: ດອກເບ້ຍດ່ຽວ I = 10,000,000 × 5 × 2 / 100 = 1,000,000. ເງິນລວມ A = 11,000,000 Kip. ແບ່ງຈ່າຍ 24 ງວດ: 11,000,000 / 24 = 458,333.3 ກີບ/ງວດ!"
  },
  summaryProblems: [
    {
      number: 1,
