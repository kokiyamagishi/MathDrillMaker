...
export const unit13Data: UnitData = {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ padding: "16px", backgroundColor: "#FFF3E0", borderRadius: "8px", border: "1px solid #FFE0B2" }}>
              <span style={{ fontSize: "1.25rem", fontWeight: "bold", color: "#E65100" }}>{"ກໍລະນີສຳຄັນ (ສໍາລັບ k > 0):"}</span>
  ...
  challengeProblems: {
    ...
    hintIndex: 0,
    hintText: "ຫວ່າງ x ∈ [-10, 1] ມີເມັດ 0 ຢູ່ທາງໃນ, ດັ່ງນັ້ນ ຄ່າຕ່ຳສຸດຂອງ y ແມ່ນ 0, ຄ່າສູງສຸດແມ່ນ (-10)² = 100. ດັ່ງນັ້ນ y ∈ [0, 100]. ສ່ວນອະສົມຜົນສອງຂ້າງ: 1/4 ≤ x² < 9/4 ⇒ 1/2 ≤ x < 3/2 (ສໍາລັບ x > 0)!"
  },
  summaryProblems: [
    {
      number: 1,
