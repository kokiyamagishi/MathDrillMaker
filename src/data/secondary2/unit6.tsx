            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "16px", padding: "10px", backgroundColor: "#FFF9C4", borderRadius: "8px", border: "1px solid #FFF59D", fontSize: "1.15rem", color: "#F57F17" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
                <span>{"ແຜນວາດການປ່ຽນພູດໃຫ້ເທົ່າກັນ (ສ່ວນ 12)"}</span>
                 <svg viewBox="0 0 340 140" style={{ width: "100%", maxWidth: "320px", height: "auto" }}>
                  {/* 1/3 (4/12) Box */}
                  <rect x="10" y="55" width="120" height="30" fill="none" stroke="#37474F" strokeWidth="2" rx="4" />
                  <line x1="50" y1="55" x2="50" y2="85" stroke="#37474F" strokeWidth="1" />
                  <line x1="90" y1="55" x2="90" y2="85" stroke="#37474F" strokeWidth="1" />
                  <rect x="10" y="55" width="40" height="30" fill="#2196F3" opacity="0.6" rx="4" />
                  
                  {/* 1/3 top fraction */}
                  <text x="30" y="20" fill="#0D47A1" fontSize="12" fontWeight="bold" textAnchor="middle">{"1"}</text>
                  <line x1="22" y1="25" x2="38" y2="25" stroke="#0D47A1" strokeWidth="1.5" />
                  <text x="30" y="39" fill="#0D47A1" fontSize="12" fontWeight="bold" textAnchor="middle">{"3"}</text>
                  
                  {/* (4/12) bottom fraction */}
                  <text x="16" y="116" fill="#0D47A1" fontSize="12" fontWeight="bold" textAnchor="middle">{"("}</text>
                  <text x="30" y="107" fill="#0D47A1" fontSize="12" fontWeight="bold" textAnchor="middle">{"4"}</text>
                  <line x1="22" y1="112" x2="38" y2="112" stroke="#0D47A1" strokeWidth="1.5" />
                  <text x="30" y="126" fill="#0D47A1" fontSize="12" fontWeight="bold" textAnchor="middle">{"12"}</text>
                  <text x="44" y="116" fill="#0D47A1" fontSize="12" fontWeight="bold" textAnchor="middle">{")"}</text>
                  
                  {/* Plus Operator */}
                  <text x="170" y="75" fill="#37474F" fontSize="24" fontWeight="bold" textAnchor="middle">{"+"}</text>
                  
                  {/* 1/4 (3/12) Box */}
                  <rect x="210" y="55" width="120" height="30" fill="none" stroke="#37474F" strokeWidth="2" rx="4" />
                  <line x1="240" y1="55" x2="240" y2="85" stroke="#37474F" strokeWidth="1" />
                  <line x1="270" y1="55" x2="270" y2="85" stroke="#37474F" strokeWidth="1" />
                  <line x1="300" y1="55" x2="300" y2="85" stroke="#37474F" strokeWidth="1" />
                  <rect x="210" y="55" width="30" height="30" fill="#4CAF50" opacity="0.6" rx="4" />
                  
                  {/* 1/4 top fraction */}
                  <text x="225" y="20" fill="#1B5E20" fontSize="12" fontWeight="bold" textAnchor="middle">{"1"}</text>
                  <line x1="217" y1="25" x2="233" y2="25" stroke="#1B5E20" strokeWidth="1.5" />
                  <text x="225" y="39" fill="#1B5E20" fontSize="12" fontWeight="bold" textAnchor="middle">{"4"}</text>
                  
                  {/* (3/12) bottom fraction */}
                  <text x="211" y="116" fill="#1B5E20" fontSize="12" fontWeight="bold" textAnchor="middle">{"("}</text>
                  <text x="225" y="107" fill="#1B5E20" fontSize="12" fontWeight="bold" textAnchor="middle">{"3"}</text>
                  <line x1="217" y1="112" x2="233" y2="112" stroke="#1B5E20" strokeWidth="1.5" />
                  <text x="225" y="126" fill="#1B5E20" fontSize="12" fontWeight="bold" textAnchor="middle">{"12"}</text>
                  <text x="239" y="116" fill="#1B5E20" fontSize="12" fontWeight="bold" textAnchor="middle">{")"}</text>
                </svg>
              </div>
            </div>
          </div>
  ...
  summaryProblems: [
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"ມີນ້ຳຫວານຢູ່ໃນຖັງ "} <Fraction num="5" den="6" /> {" ລິດຕ໌. ນາງ ນາ ໄດ້ໃຊ້ໄປ "} <Fraction num="1" den="2" /> {" ລິດຕ໌. ຖາມວ່າຍັງເຫຼືອນ້ຳຫວານຢູ່ໃນຖັງຈັກລິດຕ໌? (ໃຫ້ຄັດຈ້ອນຜົນລົບເປັນເລກສ່ວນຂັ້ນຕ່ຳ)"}
          </p>
          <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            ...
            <span className="math" style={{ display: "inline-flex", alignItems: "center", marginLeft: "6px" }}>
              {"𝑥 - "} <Fraction num="1" den="3" /> {" = "} <Fraction num="2" den="5" />
            </span>
          </p>
          <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
            <span>{"ຕອບ: 𝑥 ="}</span>
  ...
  answers: {
    items: [
      ...
      },
      {
        ...
        answers: [
          <span key="s2">{"(1) "} <Fraction num="1" den="1" /> <Fraction num="1" den="15" /> {" (ຫຼື 11/15) (ຄິດໄລ່: 𝑥 = 2/5 + 1/3 = 6/15 + 5/15 = 11/15)"}</span>
        ]
      }
    ],
