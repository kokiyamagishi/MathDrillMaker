          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "30px", margin: "8px 0" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
                ...
                <span style={{ fontSize: "1.1rem" , whiteSpace: "nowrap"}}>{"ຂວດໃບທີ 1"}</span>
              </div>
              {/* Bottle 2 Graphic */}
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
                <svg viewBox="0 0 60 100" style={{ width: "100%", maxWidth: "60px", height: "auto" }}>
                ...
                <span style={{ fontSize: "1.1rem" , whiteSpace: "nowrap"}}>{"ຂວດໃບທີ 2"}</span>
              </div>
            </div>
            <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
              <span>{"ຕອບ: ຂວດໃບທີ"}</span>
              <span className="answer-blank" style={{ display: "inline-block", width: "50px", height: "30px", verticalAlign: "middle" }}></span>
