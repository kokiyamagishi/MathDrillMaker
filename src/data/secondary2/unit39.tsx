    ...
    problems: [
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ຖ້າເມັດ A(2, 4) ແລະ B(6, 8) ມີເມັດເຄິ່ງກາງລະຫວ່າງພວກມັນແມ່ນ M(𝑥, 𝑦). ຈົ່ງຊອກຫາຕົວປະສານ 𝑥 ຂອງ M. (ສູດ: "}<i>x</i>{"_M = ("}<i>x</i>{"_A + "}<i>x</i>{"_B) / 2)"}
            </p>
            <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
              <span>{"ຕອບ: 𝑥 ="}</span>
              <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "30px", verticalAlign: "middle" }}></span>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ຈາກເມັດ A(2, 4) ແລະ B(6, 8) ທີ່ມີເມັດເຄິ່ງກາງ M(𝑥, 𝑦). ຈົ່ງຊອກຫາຕົວປະສານ 𝑦 ຂອງ M. (ສູດ: "}<i>y</i>{"_M = ("}<i>y</i>{"_A + "}<i>y</i>{"_B) / 2)"}
            </p>
            <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
              <span>{"ຕອບ: 𝑦 ="}</span>
              <span className="answer-blank" style={{ display: "inline-block", width: "100px", height: "30px", verticalAlign: "middle" }}></span>
