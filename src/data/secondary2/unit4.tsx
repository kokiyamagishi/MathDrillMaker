        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ display: "flex", justifyContent: "center", alignItems: "center", padding: "10px", backgroundColor: "#ECEFF1", borderRadius: "8px", border: "1px solid #CFD8DC" }}>
              <svg viewBox="0 0 300 50" style={{ width: "100%", maxWidth: "280px", height: "auto" }}>
                {/* Number Line */}
                <line x1="20" y1="25" x2="280" y2="25" stroke="#37474F" strokeWidth="3" />
                <line x1="20" y1="15" x2="20" y2="35" stroke="#37474F" strokeWidth="2" />
                <text x="20" y="48" fill="#37474F" fontSize="12" fontWeight="bold" textAnchor="middle">{"0"}</text>
                
                <line x1="280" y1="15" x2="280" y2="35" stroke="#37474F" strokeWidth="2" />
                <text x="280" y="48" fill="#37474F" fontSize="12" fontWeight="bold" textAnchor="middle">{"1"}</text>
                
                {/* Pin for 2/5 (0.4) */}
                <circle cx="124" cy="25" r="5" fill="#E53935" />
                <text x="124" y="14" fill="#E53935" fontSize="10" fontWeight="bold" textAnchor="middle">{"2/5 (0.4)"}</text>

                {/* Pin for 1/2 (0.5) */}
                <circle cx="150" cy="25" r="5" fill="#1E88E5" />
                <text x="150" y="14" fill="#1E88E5" fontSize="10" fontWeight="bold" textAnchor="middle">{"1/2 (0.5)"}</text>
              </svg>
            </div>
          </div>
        ),
