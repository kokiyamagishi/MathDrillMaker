          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ padding: "12px", backgroundColor: "#E8F5E9", borderRadius: "10px", border: "1px solid #A5D6A7", fontSize: "1.25rem", color: "#2E7D32" }}>
              <div style={{ paddingLeft: "12px", borderLeft: "3px solid #4CAF50", display: "flex", flexDirection: "column", gap: "6px", color: "#37474F" }}>
                ...
                <span className="math">{"ແຍກສ່ວນຄູນຂອງ 3𝑥² - 6𝑥"}</span>
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "18px", padding: "8px 0" }}>
                ...
                <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
                  <span style={{ fontWeight: "bold", marginRight: "8px" , whiteSpace: "nowrap"}}>{"(1) "}</span>
                  <span className="math">{"3𝑥² - 6𝑥 = 3𝑥(𝑥 - ?)"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "80px", height: "30px", verticalAlign: "middle" }}></span>
                </div>
                ...
                <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
                  <span style={{ fontWeight: "bold", marginRight: "8px" , whiteSpace: "nowrap"}}>{"(3) "}</span>
                  <span className="math">{"𝑥³ - 5𝑥² = 𝑥²(𝑥 - ?)"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "80px", height: "30px", verticalAlign: "middle" }}></span>
                </div>
                ...
                <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
                  <span style={{ fontWeight: "bold", marginRight: "8px" , whiteSpace: "nowrap"}}>{"(5) "}</span>
                  <span className="math">{"4𝑥²𝑦 - 8𝑥𝑦 = 4𝑥𝑦(𝑥 - ?)"}</span>
                  <span className="answer-blank" style={{ display: "inline-block", width: "80px", height: "30px", verticalAlign: "middle" }}></span>
                </div>
              </div>
            </div>
  ...
  summaryProblems: [
    {
      ...
      content: (
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          ...
          <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
            {"ຈົ່ງແຍກສ່ວນຄູນຂອງສຳນວນ 5𝑥³ - 20𝑥 = 5𝑥(𝑥² - ?)"}
          </p>
          <div style={{ fontSize: "1.375rem", lineHeight: "1.7" }}>
  ...
  answers: {
    items: [
      ...
      },
      {
        questionNumber: 2,
        answers: [
          <span key="2-1">{"(1) 2 (ຄິດໄລ່: 3𝑥(𝑥 - 2) = 3𝑥² - 6𝑥)"}</span>,
          <span key="2-2">{"(2) 2 (ຄິດໄລ່: a(a + 2) = a² + 2a)"}</span>,
          <span key="2-3">{"(3) 5 (ຄິດໄລ່: 𝑥²(𝑥 - 5) = 𝑥³ - 5𝑥²)"}</span>,
          <span key="2-4">{"(4) b (ຄິດໄລ່: ab(a + b) = a²b + ab²)"}</span>,
          <span key="2-5">{"(5) 2 (ຄິດໄລ່: 4𝑥𝑦(𝑥 - 2) = 4𝑥²𝑦 - 8𝑥𝑦)"}</span>
        ]
      },
      {
      ...
      },
      {
        ...
        answers: [
          <span key="s1">{"(1) 4 (ຄິດໄລ່: 5𝑥(𝑥² - 4) = 5𝑥³ - 20𝑥)"}</span>
        ]
      },
      {
