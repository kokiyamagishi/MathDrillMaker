        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
            ...
            <div style={{ padding: "12px 16px", backgroundColor: "#E3F2FD", borderRadius: "10px", border: "1px solid #90CAF9", fontSize: "1.25rem", color: "#1565C0" }}>
              {"1. ວາງຕົວລັບ "} <span className="math">{"x"}</span> {" ແທນສິ່ງທີ່ຕ້ອງການຊອກຫາ."}<br />
            ...
            <div style={{ display: "flex", justifyContent: "center", gap: "16px", padding: "10px", backgroundColor: "#E8F5E9", borderRadius: "8px", border: "1px solid #C8E6C9", fontSize: "1.15rem", color: "#2E7D32" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "6px", width: "100%" }}>
                ...
                <svg viewBox="0 0 300 50" style={{ width: "100%", maxWidth: "260px", height: "auto" }}>
                  ...
                  <text x="90" y="28" fill="#FFFFFF" fontSize="9" textAnchor="middle" fontWeight="bold">{"ຄ່າໃຊ້ຈ່າຍ (8,000x)"}</text>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <p style={{ fontSize: "1.375rem", margin: 0, lineHeight: "1.6" }}>
              {"ຮູບສາມແຈສະເໝີໜຶ່ງມີຄວາມຍາວຂ້າງແມ່ນ "} <span className="math">{"x"}</span> {" ຊັງຕີແມັດ. ຖ້າລວງຮອບຂອງຮູບສາມແຈນີ້ບໍ່ເກີນ 48 ຊັງຕີແມັດ, ແລ້ວຄວາມຍາວຂ້າງສູງສຸດຂອງມັນຈະແມ່ນເທົ່າໃດ? (ລວງຮອບ = 3x)"}
            </p>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap", fontSize: "1.375rem" }}>
  ...
  answers: {
    items: [
      ...
      },
      {
        ...
        answers: [
          <span key="11">{"50 ກິໂລແມັດ (ເພາະວ່າ 200,000 + 5,000x < 100,000 + 7,000x ➔ 100,000 < 2,000x ➔ x > 50)"}</span>
        ]
      },
      {
        questionNumber: "ທ້າທາຍ 2",
        answers: [
          <span key="12">{"16 cm (ເພາະວ່າ 3x ≤ 48 ➔ x ≤ 16)"}</span>
        ]
      },
      {
        questionNumber: "ທົດສອບປະຈຳບົດ 1",
        answers: [
          <span key="13">{"7 ກິໂລກຣາມ (ເພາະວ່າ 15,000 + 5,000(x - 1) ≤ 45,000 ➔ 5,000(x - 1) ≤ 30,000 ➔ x - 1 ≤ 6 ➔ x ≤ 7)"}</span>
        ]
      },
      {
        questionNumber: "ທົດສອບປະຈຳບົດ 2",
        answers: [
          <span key="14">{"9.2 ຄະແນນ (ເພາະວ່າ 9.5 + 8.5 + 9.0 + 8.8 + x ≥ 45.0 ➔ 35.8 + x ≥ 45 ➔ x ≥ 9.2)"}</span>
        ]
      }
    ],
