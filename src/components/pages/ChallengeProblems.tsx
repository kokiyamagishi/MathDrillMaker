...
interface ChallengeProblemsProps {
  ...
  hintIndex?: number; // Which problem to show the hint after
  hintText?: string | React.ReactNode;
}

export const ChallengeProblems: React.FC<ChallengeProblemsProps> = ({
  pageNumber,
  unitNumber,
  unitTitle,
  problems,
    ...
    <div className="drill-page" style={{ textAlign: "left" }}>
      <div className="drill-header">
        ...
        <div className="drill-header__unit-info">
          ...
          <p className="drill-header__unit-goal">ບົດຝຶກຫັດທ້າທາຍ — ຂັ້ນຕອນທີ 2</p>
        </div>
      </div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "16px" }}>
        <div className="section-title" style={{ marginBottom: 0 }}>
          ...
          <span className="section-title__text">ບົດຝຶກຫັດທ້າທາຍ</span>
          <span className="section-title__badge">ຂັ້ນຕອນ 2</span>
        </div>
      ...
      <div className="problem-area">
        {problems.map((problem, index) => (
          <React.Fragment key={problem.number}>
            <div className="problem" style={{ marginTop: index > 0 ? "36px" : "0px" }}>
            ...
            {/* Show hint box if applicable */}
            {hintIndex === index && hintText && (
