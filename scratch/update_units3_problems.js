    ...
    challengeProblems: {
      problems: [
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງແກ້ໂຈດບັນຫາກ່ຽວກັບຄວາມຍາວຮອບຮູບ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຕອບຄຳຖາມກ່ຽວກັບຮູບສາມແຈ: "} <span className="point-label">{"(ຂໍ້ລະ 5 ຄະແນນ, ລວມ 10 ຄະແນນ)"}</span></p>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາຄວາມຍາວຮອບຮູບສາມແຈທ່ຽງ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
              <p>{"(3) ມີຮູບສາມແຈທ່ຽງຮູບໜຶ່ງ ເຊິ່ງມີສອງຂ້າງຍາວ 7cm ແລະ ຂ້າງທີ່ເຫຼືອຍາວ 4cm. ຄວາມຍາວຮອບຮູບແມ່ນຈັກ cm?"}</p>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <span>{"ຄຳຕອບ:"}</span>
                <span className="answer-blank" style={{ display: "inline-block", width: "120px", height: "40px" }}></span>
                <span>{"cm"}</span>
  ...
  },
  {
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div style={{ display: "flex", justifyContent: "flex-start", gap: "32px", alignItems: "flex-start" }}>
            ...
            <div style={{ fontSize: "18px", maxWidth: "450px", lineHeight: "1.6" }}>
              ...
              <p style={{ margin: "2px 0 2px 16px" }}>{"• ຊັກລົງມາ: ຊັກເລກ '6' ລົງມາໃສ່ທາງຂ้างເລກ 1 ຈະໄດ້ '16'."}</p>
    ...
    basicProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາການຫານ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    challengeProblems: {
      problems: [
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງແກ້ໂຈດບັນຫາການຫານທີ່ມີເສດ: "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຄິດໄລ່ການຫານຕໍ່ໄປນີ້ຕາມທາງຕັ້ງ: "} <span className="point-label">{"(ຂໍ້ລະ 2.5 ຄະແນນ, ລວມ 10 ຄະແນນ)"}</span></p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "24px", paddingLeft: "16px" }}>
              {[
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຕື່ມຕົວເລກໃສ່ບ່ອນວ່າງໃນການກວດຄືນການຫານ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    basicProblems: [
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຕອບຄຳຖາມກ່ຽວກັບຈຳນວນເທື່ອລຸ່ມນີ້: "} <span className="point-label">{"(ຂໍ້ລະ 2.5 ຄະແນນ, ລວມ 10 ຄະແນນ)"}</span></p>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາຄວາມຍາວ: "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
              <p>{"(5) ເຊືອກເສັ້ນໜຶ່ງຍາວ 24 ແມັດ, ເຊິ່ງຍາວເປັນ 3 ເທື່ອຂອງເຊືອກສີແດງ. ເຊືອກສີແດງຍາວຈັກແມັດ?"}</p>
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <span>{"ຄຳຕອບ:"}</span>
                <span className="answer-blank" style={{ display: "inline-block", width: "120px", height: "40px" }}></span>
                <span>{"ແມັດ"}</span>
      ...
      problems: [
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງຄິດໄລ່ເພື່ອຊອກຫາຄຳຕອບ: "} <span className="point-label">{"(ຂໍ້ລະ 5 ຄະແນນ, ລວມ 10 ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "24px" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                  <p style={{ fontSize: "22px", margin: 0 }}>{"(2) ຖ້າຮູ້ວ່າແຖບສີເຫຼືອງຍາວ 15m, ເຊິ່ງຍາວເປັນ 3 ເທື່ອຂອງແຖບສີຂຽວ. ແຖບສີຂຽວຍາວຈັກແມັດ?"}</p>
                  <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                    <span>{"ຄຳຕອບ:"}</span>
                    <span className="answer-blank" style={{ display: "inline-block", width: "120px", height: "40px" }}></span>
                    <span>{"ແມັດ"}</span>
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງແກ້ໂຈດບັນຫາຄວາມຍາວຂອງໄມ້ບັນທັດ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາຕໍ່ໄປນີ້: "} <span className="point-label">{"(ຂໍ້ລະ 5 ຄະແນນ, ລວມ 10 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "24px" }}>
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາຄວາມສູງຂອງຕົ້ນໄມ້: "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
  ...
  },
  {
    ...
    basicProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຄິດໄລ່ເລກທົດສະນິຍົມຢ່າງງ່າຍ: "} <span className="point-label">{"(ຂໍ້ລະ 5 ຄະແນນ, ລວມ 10 - ຄະແນນ)"}</span></p>
    ...
    challengeProblems: {
      problems: [
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງແກ້ໂຈດບັນຫາເລກທົດສະນິຍົມ: "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງປຽບທຽບນ້ຳໜັກຕໍ່ໄປນີ້: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
  ...
  },
  {
    ...
    basicProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຕອບຄຳຖາມຈາກຂໍ້ມູນຕາຕະລາງຕໍ່ໄປນີ້: (ຜັກກາດ 8 ຄົນ, ຜັກບົ້ງ 12 ຄົນ, ຜັກຫອມ 6 ຄົນ)"} <span className="point-label">{"(5 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    challengeProblems: {
      problems: [
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງຕອບຄຳຖາມຈາກຕາຕະລາງຂ້າງເທິງ: "} <span className="point-label">{"(5 ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຕອບຄຳຖາມກ່ຽວກັບກຣາບເສົາ: "} <span className="point-label">{"(5 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
  ...
  },
  {
    ...
    basicProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາເລກສ່ວນ (ການບວກ): "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    challengeProblems: {
      problems: [
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງແກ້ໂຈດບັນຫາເລກສ່ວນ (ການລົບ): "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຕອບຄຳຖາມກ່ຽວກັບຄວາມໝາຍຂອງເລກສ່ວນ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
  ...
  },
  {
    ...
    basicProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງຄິດໄລ່ຈຳນວນເງິນລວມ: "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    challengeProblems: {
      problems: [
        ...
        },
        {
          ...
          content: (
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              <p>{"ຈົ່ງແກ້ໂຈດບັນຫາການຊື້ເຄື່ອງ ແລະ ທອນເງິນ: "} <span className="point-label">{"(10 ຄະແນນ)"}</span></p>
              <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
    ...
    summaryProblems: [
      ...
      },
      {
        ...
        content: (
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <p>{"ຈົ່ງແກ້ໂຈດບັນຫາການຊື້ກະເປົາ: "} <span className="point-label">{"(10 - ຄະແນນ)"}</span></p>
            <div style={{ paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "12px", fontSize: "20px" }}>
...
const finalContent = headerAndUnits1To10 + newUnits11To17.trim() + '\n';
fs.writeFileSync(filePath, finalContent, 'utf8');
console.log("Successfully updated units3.tsx with expanded problems and adjusted layouts.");
